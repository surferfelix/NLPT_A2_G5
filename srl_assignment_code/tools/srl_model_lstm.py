...
def write_bio_formatted_tags_to_file(
    ...
    [the shared task srl_data README](https://www.lsi.upc.edu/~srlconll/conll05st-release/README).
...
@Model.register("srl_lstm_cltl")
class SemanticRoleLabelerLSTM(Model):
    """
